...
namespace TN.API.Controllers
{
    ...
    [ApiController]
    public class TableStatusController : BaseController<TableStatus, ITableStatusSevice>
    {
        public TableStatusController(ITableStatusSevice service)
          : base(service)
        {
        }
		[HttpGet("Search")]
		...
		[HttpPost("Create")]
		public async Task<IActionResult> Create([FromBody] TableStatusModel obj)
		{
			try
			{
				if (!ModelState.IsValid)
		...
		[HttpPut("Edit")]
		public async Task<IActionResult> Edit([FromBody] TableStatusModel obj)
		{
			try
			{
				if (!ModelState.IsValid)

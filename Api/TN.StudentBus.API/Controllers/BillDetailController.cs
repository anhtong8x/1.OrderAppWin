...
namespace TN.API.Controllers
{
    ...
    [ApiController]
    public class BillDetailController : BaseController<BillDetail, IBillDetailService>
    {
		...
		[HttpPost("Create")]
        public async Task<IActionResult> Create([FromBody] BillDetailModel obj)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        [HttpPut("Edit")]
        public async Task<IActionResult> Edit([FromBody] BillDetailModel obj)
        {
            try
            {
                if (!ModelState.IsValid)
